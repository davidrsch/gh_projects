...
export class ColumnHeaderRenderer {
    ...
    public render(table: HTMLTableElement) {
        ...
        for (const field of this.options.fields) {
            ...
            const isSliced = (this.options.activeSlice && this.options.activeSlice.fieldId === field.id) ||
                (this.options.activeSlicePanelFieldId && String(this.options.activeSlicePanelFieldId) === String(field.id));
        ...
        addFieldBtn.addEventListener('click', () => this.options.onShowFieldsMenu(addFieldBtn));
